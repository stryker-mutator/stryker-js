...
for package in api core cucumber-runner instrumenter jasmine-runner jest-runner karma-runner mocha-runner node-test-runner typescript-checker util tap-runner vitest-runner
do
