...
async function main() {
  await instrument(
    {
      './packages/mocha-runner/testResources/sample-project/MyMath.js':
        './packages/mocha-runner/testResources/sample-project-instrumented/MyMath.js',
  ...
  await instrument({
    './packages/karma-runner/testResources/sampleProject/src/Add.js':
      './packages/karma-runner/testResources/instrumented/src/Add.js',
    './packages/karma-runner/testResources/sampleProject/src/Circle.js':
      './packages/karma-runner/testResources/instrumented/src/Circle.js',
  ...
  await instrument(
    {
      './packages/jest-runner/testResources/jasmine2-node/src/Add.js':
        './packages/jest-runner/testResources/jasmine2-node-instrumented/src/Add.js',
  ...
  await instrument(
    {
      './packages/tap-runner/testResources/example/src/math.js':
        './packages/tap-runner/testResources/example-instrumented/src/math.js',
      './packages/tap-runner/testResources/example/src/formatter.js':
        './packages/tap-runner/testResources/example-instrumented/src/formatter.js',
    },
    '__stryker2__',
  );
  await instrument(
  ...
  await instrument(
    {
      './packages/vitest-runner/testResources/async-failure/src/add.orig.ts':
        './packages/vitest-runner/testResources/async-failure/src/add.ts',
    },
    '__stryker2__',
  );
  await instrument(
...
async function instrument(
  fromTo,
  globalNamespace = INSTRUMENTER_CONSTANTS.NAMESPACE,
) {
  const files = Object.keys(fromTo).map((fileName) => ({
    mutate: true,
    name: fileName,
    content: readFileSync(fileName, 'utf-8'),
  }));
  const out = await instrumenter.instrument(files, {
    plugins: null,
    excludedMutations: [],
    ignorers: [],
  });
