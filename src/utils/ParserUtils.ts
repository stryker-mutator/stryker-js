 ...
 */
ParserUtils.prototype.parse = function(code) {
 ...
 */
ParserUtils.prototype.getNodesWithType = function(abstractSyntaxTree, types, nodes, parent, key) {
 ...
 */
ParserUtils.prototype.generate = function(ast, originalCode) {
