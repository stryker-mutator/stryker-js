...
## Introduction
For an introduction to mutation testing and Stryker's features, see [stryker-mutator.io](http://stryker-mutator.io/).
...
## Supported mutators  
See our website for the [list of currently supported mutators](http://stryker-mutator.io/mutators.html).
...
See the [list of plugins](http://stryker-mutator.io/plugins.html) for an up-to-date list of supported test runners and plugins.
...
You can load additional plugins to get more reporters. See [stryker-mutator.io](http://stryker-mutator.io)
...
[stryker-mutator.io](http://stryker-mutator.io).
