...
import CustomJestConfigLoader, * as defaultJestConfigLoader from '../../../src/configLoaders/custom-jest-config-loader';
import ReactScriptsJestConfigLoader, * as reactScriptsJestConfigLoader from '../../../src/configLoaders/react-scripts-jest-config-loader';
import ReactScriptsTSJestConfigLoader, * as reactScriptsTSJestConfigLoader from '../../../src/configLoaders/react-scripts-ts-jest-config-loader';
