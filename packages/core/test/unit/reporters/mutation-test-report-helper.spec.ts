...
//         mutatorName: 'Foo',
//         replacement: 'foo replacement',
//         status: mutationTestReportMutantStatus.Killed,
//       });
//       expect(actualReport.files['bar.js'].mutants[0]).include({ status: mutationTestReportMutantStatus.NoCoverage });
//       expect(actualReport.files['baz.js'].mutants[0]).include({ status: mutationTestReportMutantStatus.RuntimeError });
//       expect(actualReport.files['qux.js'].mutants[0]).include({ status: mutationTestReportMutantStatus.Survived });
//       expect(actualReport.files['5.js'].mutants[0]).include({ status: mutationTestReportMutantStatus.Timeout });
//       expect(actualReport.files['6.js'].mutants[0]).include({ status: mutationTestReportMutantStatus.CompileError });
//     });
...
//         factory.mutantTestCoverage({ mutant: factory.mutant({ fileName: 'add.js' }) }),
...
//       // Act
//       const actual = sut.reportMutantRunResult(
//         factory.mutantTestCoverage({ mutant: factory.mutant({ fileName: 'add.js' }), testFilter: ['1'] }),
...
//       // Act
//       const actual = sut.reportMutantRunResult(
//         factory.mutantTestCoverage({ mutant: factory.mutant({ fileName: 'add.js' }), testFilter: undefined }),
