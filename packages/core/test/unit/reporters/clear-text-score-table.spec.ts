    ...
    it('should report the clear text table with correct values', () => {
      const metricsResult: MetricsResult = new MetricsResult(
        ...
        factory.metrics({
          ...
          killed: 1,
          mutationScore: 80,
          mutationScoreBasedOnCoveredCode: 82,
          noCoverage: 4,
          runtimeErrors: 4,
          survived: 3,
          timeout: 2,
      ...
      expect(rows).to.deep.eq([
        ...
        '-------------------------------|--------|---------|----------|-----------|------------|----------|----------|',
        `All files                      |${chalk.green('  80.00 ')}|${chalk.green('   82.00 ')}|        1 |         2 |          3 |        4 |       11 |`,
        ` child1                        |${chalk.yellow('  60.00 ')}|${chalk.yellow('   62.00 ')}|        0 |         0 |          0 |        0 |        0 |`,
        `  some/test/for/a/deep/file.js |${chalk.red('  59.99 ')}|${chalk.red('   58.00 ')}|        0 |         0 |          0 |        0 |        0 |`,
        '-------------------------------|--------|---------|----------|-----------|------------|----------|----------|',
      ]);
    });
