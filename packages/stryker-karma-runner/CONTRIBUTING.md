...
This is the contribution guide for stryker-karma-runner. Great to have you here! Here are a few ways you can help make this project better.

## Team members

* Simon de Lang: [simondel](http://github.com/simondel) on github.
...
3. When writing your code, please conform to the existing coding style.
   See [.editorconfig](https://github.com/stryker-mutator/stryker-karma-runner/blob/master/.editorconfig) and the [typescript guidelines](https://github.com/Microsoft/TypeScript/wiki/Coding-guidelines)
...
Please report a bug report on our [issues page](https://github.com/stryker-mutator/stryker-karma-runner/issues). In this please:
