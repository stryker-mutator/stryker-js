import { TestStatus, TestResult, CoverageCollection, CoverageCollectionPerTest, RunStatus } from '@stryker-mutator/api/test_runner';
...
export default class StrykerReporter extends EventEmitter implements karma.Reporter {
  ...
  private static innerInstance = new StrykerReporter();
  static get instance(): StrykerReporter {
    if (!this.innerInstance) {
      this.innerInstance = new StrykerReporter();
    }
