...
//     mutantCollectorMock.findUnplacedMutantsHere.returns([]).onThirdCall().returns([mutant]);
//     mutantPlacerStub.returns(types.booleanLiteral(true));
...
//     const mutant = createMutant();
//     mutantCollectorMock.findUnplacedMutantsHere.returns([]).onThirdCall().returns([mutant]);
//     mutantPlacerStub.onThirdCall().returns(types.booleanLiteral(true));
