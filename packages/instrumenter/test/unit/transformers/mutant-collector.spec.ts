...
//   describe(MutantCollector.prototype.findUnplacedMutantsHere.name, () => {
...
//       // Act
//       const actual = sut.findUnplacedMutantsHere({ start: 4, end: 7 });
...
//       // Act
//       const actual = sut.findUnplacedMutantsHere({ start: 1, end: 99 });
