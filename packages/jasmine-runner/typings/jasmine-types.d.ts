...
declare namespace jasmine {
   ...
   * @since 3.6.0
   */
  function setSpecProperty(key: string, value: unknown): void;
   ...
   * @since 3.6.0
   */
  function setSuiteProperty(key: string, value: unknown): void;
  ...
  type CustomAsyncMatcherFactories = Record<string, CustomAsyncMatcherFactory>;
   ...
   */
  type SpecFilter = (spec: Spec) => boolean;
