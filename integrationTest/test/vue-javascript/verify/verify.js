...
describe('After running stryker on VueJS project', function () {
    it('should report 25% mutation score', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    chai_1.expect(scoreResult.killed).eq(4);
                    chai_1.expect(scoreResult.survived).eq(12);
                    chai_1.expect(scoreResult.mutationScore).to.equal(25);
                    return [2 /*return*/];
            }
        });
    }); });
