# Stryker maintainer handbook

## Introduction
We've written this document for:

1. Active maintainers of Stryker
1. Prospective maintainers of Stryker
1. Anyone curious about how Stryker's maintainers maintain Stryker
...
However, **there is no expectation of a standard of technical ability** to be a maintainer of Stryker. This doesn't imply a lack of technical oversight--every pull request will eventually be reviewed.

**If you think you aren't experienced enough to maintain a project like Stryker, you are incorrect.** The only requirements are the above responsibilities and a desire to help the project. It bears repeating:
...
## Reaching decisions 
Stryker follows a [consensus-seeking decision-making](https://en.wikipedia.org/wiki/Consensus-seeking_decision-making) process. In other words, all maintainers attempt to come to an agreement. If that fails, owners will decide.
...
All new issues will need to be triaged, and pull requests must be examined. Maintainers must understand [Semantic Versioning](http://semver.org) ("SemVer"), as Stryker follows it semi-strictly.
...
These are users who feel the Stryker project and its maintainers _owe them_ time or support. This is incorrect.
...
* Stryker (for JavaScript and friends)
* Stryker.NET (for C# and maybe other .NET languages)
* Stryker4s (for scala and maybe other JVM languages)

Since Stryker began only for JavaScript and friends, it is often simply referred to as “Stryker”. 

The scope for Stryker is “JavaScript and friends”. This includes all test frameworks and all babel parsable JavaScript languages. Some examples:
